...
4. [Images](#images)
### Prerequisites
[Java 25](https://adoptium.net/temurin/releases/) is used for this, if you aren't able to run the program install Java 25.
### Notice
...
2. Run the `.msi` file and install the program.
3. Search for `Discord Batch Delete` and double click it to launch it.
